...
export declare class ClientProfileController {
    ...
    updateOwnProfile(user: JwtPayload, dto: UpdateClientProfileDto): Promise<{
        data: {
            user: {
                id: string;
                createdAt: Date;
    ...
    getTeam(user: JwtPayload): Promise<{
        data: ({
            user: {
                id: string;
                createdAt: Date;
    ...
    inviteTeamMember(user: JwtPayload, dto: InviteTeamMemberDto): Promise<{
        data: {
            user: {
                id: string;
                phone: string;
