...
let AuthController = class AuthController {
    ...
    async selectRole(dto, authHeader) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Register a new CLIENT or SP user' }),
...
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Post)('admin/select-role'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Admin role selection after multi-role login' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Headers)('authorization')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.SelectRoleDto, String]),
    __metadata("design:returntype", Promise)
